...
namespace KSignal.API.Data;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var marketSnapshotLatest = modelBuilder.Entity<MarketSnapshotLatest>();
        marketSnapshotLatest.ToTable("market_snapshots_latest");
        marketSnapshotLatest.HasKey(e => e.MarketSnapshotID);
        marketSnapshotLatest.Property(e => e.MarketSnapshotID).ValueGeneratedOnAdd();
        marketSnapshotLatest.HasIndex(e => e.Ticker);
        marketSnapshotLatest.HasIndex(e => e.EventTicker);
        marketSnapshotLatest.Property(e => e.Ticker).HasMaxLength(255).IsRequired();
        marketSnapshotLatest.Property(e => e.EventTicker).HasMaxLength(255).IsRequired();
        marketSnapshotLatest.Property(e => e.MarketType).HasMaxLength(50).IsRequired();
        marketSnapshotLatest.Property(e => e.YesSubTitle);
        marketSnapshotLatest.Property(e => e.NoSubTitle);
        marketSnapshotLatest.Property(e => e.CreatedTime).IsRequired();
        marketSnapshotLatest.Property(e => e.OpenTime).IsRequired();
        marketSnapshotLatest.Property(e => e.CloseTime).IsRequired();
        marketSnapshotLatest.Property(e => e.ExpectedExpirationTime);
        marketSnapshotLatest.Property(e => e.LatestExpirationTime).IsRequired();
        marketSnapshotLatest.Property(e => e.FeeWaiverExpirationTime);
        marketSnapshotLatest.Property(e => e.SettlementValue);
        marketSnapshotLatest.Property(e => e.SettlementValueDollars);
        marketSnapshotLatest.Property(e => e.Status).HasMaxLength(64).IsRequired();
        marketSnapshotLatest.Property(e => e.Result).HasMaxLength(10).IsRequired();
        marketSnapshotLatest.Property(e => e.CanCloseEarly).IsRequired();
        marketSnapshotLatest.Property(e => e.ResponsePriceUnits).HasMaxLength(50).IsRequired();
        marketSnapshotLatest.Property(e => e.YesBid).IsRequired();
        marketSnapshotLatest.Property(e => e.YesBidDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.YesAsk).IsRequired();
        marketSnapshotLatest.Property(e => e.YesAskDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.NoBid).IsRequired();
        marketSnapshotLatest.Property(e => e.NoBidDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.NoAsk).IsRequired();
        marketSnapshotLatest.Property(e => e.NoAskDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.LastPrice).IsRequired();
        marketSnapshotLatest.Property(e => e.LastPriceDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousYesBid).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousYesBidDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousYesAsk).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousYesAskDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousPrice).IsRequired();
        marketSnapshotLatest.Property(e => e.PreviousPriceDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.Volume).IsRequired();
        marketSnapshotLatest.Property(e => e.Volume24h).IsRequired();
        marketSnapshotLatest.Property(e => e.OpenInterest).IsRequired();
        marketSnapshotLatest.Property(e => e.NotionalValue).IsRequired();
        marketSnapshotLatest.Property(e => e.NotionalValueDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.Liquidity).IsRequired();
        marketSnapshotLatest.Property(e => e.LiquidityDollars).IsRequired();
        marketSnapshotLatest.Property(e => e.ExpirationValue).IsRequired();
        marketSnapshotLatest.Property(e => e.TickSize).IsRequired();
        marketSnapshotLatest.Property(e => e.StrikeType).HasMaxLength(50);
        marketSnapshotLatest.Property(e => e.FloorStrike);
        marketSnapshotLatest.Property(e => e.CapStrike);
        marketSnapshotLatest.Property(e => e.FunctionalStrike);
        marketSnapshotLatest.Property(e => e.CustomStrike);
        marketSnapshotLatest.Property(e => e.MveCollectionTicker).HasMaxLength(255);
        marketSnapshotLatest.Property(e => e.MveSelectedLegs);
        marketSnapshotLatest.Property(e => e.PrimaryParticipantKey).HasMaxLength(255);
